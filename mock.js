  ...
  "tree": [{
    ...
    "children": [{
      ...
      "children": [{
        ...
        "title": "测试方法",
        "selected": 0,
        "description": "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;这是目标：这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标；<br/><br/>  这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是目标这是。<br/><br/>  这是依据：这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据；<br/><br/>  这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据这是依据；",
        "params": []
      }]
    }, {
      "id": 2,
...
const getAllTree = {
  ...
  "tree": [{
    ...
    "type": "category",
    "title": "部门预算执行审计", //类别名称
    "description": "预算执部门预算执行审计行情况", //类别描述
    "isEnable": 1, //是否启用
    "sort": 2, //排序
    "children": [{
      "id": 13, //ID
      "type": "issues",
      "title": "部门预算执行总体情况", //项目名称
      "description": "部门预算执行总体情况", //项目描述
      "isDefault": 1, //是否默认
      "isEnable": 1, //是否启用
      "children": [{
        "id": 195, //ID
        "type": "method",
        "title": "01 部门预算执行总体情况和执行率", //方法名称
        "selected": 1, //是否默认
        "accord": "定性依据", //定性依据
        "externalDataSource": "", //外部数据源
        "innerDataSource": "", //内部数据源
        //方法主体
        ...
        "isEnable": 1, //是否启用
        "sort": 1, // 排序
        "methodType": "model", //方法类型 取值：model、basic
        "autidType": "自动", //审计方法，取值：自动、人工
        //方法描述
      ...
      "children": [{
        ...
        "title": "测试方法",
        "selected": 1,
        "methodCode": "select '值1' as 列1,'值2' as 列2,'值3' as 列3\r\nunion all\r\nselect '值1' as 列1,'值2' as 列2,'值3' as 列3\r\nunion all\r\nselect '值1' as 列1,'值2' as 列2,'值3' as 列3\r\nunion all\r\nselect '值1' as 列1,'值2' as 列2,'值3' as 列3\r\nunion all\r\nselect '值1' as 列1,'值2' as 列2,'值3' as 列3\r\nunion all\r\nselect '值1' as 列1,'值2' as 列2,'值3' as 列3\r\nunion all\r\nselect '值1' as 列1,'值2' as 列2,'值3' as 列3",
        "isEnable": 1,
        "sort": 1,
        "methodType": "model",
        "autidType": "自动",
        ...
        "title": "测试Basic",
        "selected": 1,
        "methodCode": "select 'kkk' as kk waitfor delay '00:05:00'",
        "isEnable": 1,
        "sort": 23,
        "methodType": "basic",
        "autidType": "自动",
    ...
    "children": [{
      ...
      "children": [{
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "预算执行系统中，经财政厅批复的全部预算单位指标。",
        "params": [{
          "id": 217,
          "name": "单位编码",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "预算执行系统中，预算单位上报的用款计划，经财政厅国库处批复后形成用款额度，“核批金额”即为额度金额，预算单位据此入账，记财政拨款收入。",
        "params": [{
          "id": 219,
          "name": "单位编码",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "预算执行系统中，预算单位的实际支出凭证。预算单位据此入账，记财政拨款支出。",
        "params": [{
          "id": 221,
          "name": "单位编码",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "预算单位收取的各项非税收入，包括罚没收入、各类行政事业性收费等。",
        "params": [{
          "id": 223,
          "name": "单位名称",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "预算单位从财政部门购领的各类非税收入征收票据信息。",
        "params": [{
          "id": 225,
          "name": "单位名称",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "预算单位的财政供养人员信息。人员身份包含公务员、参（依）照公务员管理人员、事业管理人员、事业专业技术人员、技术工人、普通工人等。",
        "params": [{
          "id": 229,
          "name": "单位编码",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "由财政统一发放工资的人员及其工资信息。",
        "params": [{
          "id": 230,
          "name": "单位编码",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "财政供养人员注册的企业为集中支付供应商。",
        "params": [{
          "id": 234,
          "name": "单位编码",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "财政供养人员参股的企业为集中支付供应商。",
        "params": [{
          "id": 235,
          "name": "单位编码",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "预算单位在质监部门登记的组织机构代码信息。",
        "params": [{
          "id": 236,
          "name": "单位名称",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "以预算单位名称中的关键字为条件，模糊查询相关企业的工商登记信息。",
        "params": [{
          "id": 237,
          "name": "单位名称",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "以预算单位名称中的关键字为条件，模糊查询相关企业的工商登记变更历史信息。",
        "params": [{
          "id": 238,
          "name": "单位名称",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "以预算单位名称中的关键字为条件，模糊查询相关企业的股东登记信息。",
        "params": [{
          "id": 239,
          "name": "单位名称",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "以预算单位名称中的关键字为条件，模糊查询相关企业的股东登记变更历史信息。",
        "params": [{
          "id": 240,
          "name": "单位名称",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "以预算单位名称中的关键字为条件，模糊查询相关纳税人的登记基本信息。",
        "params": [{
          "id": 241,
          "name": "单位名称",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "以预算单位名称中的关键字为条件，模糊查询相关企业在地税部门的纳税信息。",
        "params": [{
          "id": 242,
          "name": "单位名称",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "以预算单位名称中的关键字为条件，模糊查询相关企业在国税部门的纳税信息。",
        "params": [{
          "id": 244,
          "name": "单位名称",
          "type": "string",
        ...
        "methodType": "basic",
        "autidType": "自动",
        "description": "以预算单位名称中的关键字为条件，模糊查询相关企业在地税部门代开的发票信息。",
        "params": [{
          "id": 245,
          "name": "单位名称",
          "type": "string",
